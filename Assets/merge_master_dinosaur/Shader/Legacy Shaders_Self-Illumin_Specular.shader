...
void main()
{
    ...
    u_xlat16_12 = texture(_Illum, vs_TEXCOORD0.zw).w;
    SV_Target0.xyz = u_xlat16_2.xyz * vec3(u_xlat16_12) + u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat16_2.xyz * _LightColor0.xyz;
    u_xlat0.xyz = u_xlat16_3.xyz * vec3(u_xlat16_14) + u_xlat0.xyz;
    u_xlat16_3.xyz = u_xlat16_2.xyz * vs_TEXCOORD3.xyz + u_xlat0.xyz;
    u_xlat16_0 = texture(_Illum, vs_TEXCOORD0.zw).w;
...
void main()
{
    ...
    u_xlat16_15 = texture(_Illum, vs_TEXCOORD0.zw).w;
    SV_Target0.xyz = u_xlat16_4.xyz * vec3(u_xlat16_15) + u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat16_4.xyz * u_xlat2.xyz + u_xlat0.xyz;
    u_xlat16_0 = texture(_Illum, vs_TEXCOORD0.zw).w;
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat16_7.xyz * u_xlat3.xyz + u_xlat16_4.xyz;
    u_xlat16_1.x = texture(_Illum, vs_TEXCOORD0.zw).w;
    SV_Target0.xyz = u_xlat16_7.xyz * u_xlat16_1.xxx + u_xlat16_4.xyz;
    SV_Target0.w = 1.0;
    return;
}
