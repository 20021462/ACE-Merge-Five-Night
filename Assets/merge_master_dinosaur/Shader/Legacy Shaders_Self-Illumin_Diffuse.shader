...
void main()
{
    ...
    u_xlati5 = u_xlati5 * 7;
    u_xlat16_7 = (-u_xlat16_2.x) + unity_Builtins2Array[u_xlati5 / 7].unity_SHCArray.w;
    u_xlat16_2.x = u_xlat0.x * u_xlat16_7 + u_xlat16_2.x;
    u_xlat16_2.xyz = u_xlat16_2.xxx * _LightColor0.xyz;
    u_xlat16_0.xzw = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_0.xzw * _Color.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_3.xyz;
    u_xlat1.xyz = vs_TEXCOORD1.xyz;
    u_xlat1.w = 1.0;
...
SubProgram "vulkan hw_tier00 " {
Keywords { "INSTANCING_ON" }
"// disassembly error Index was out of range. Must be non-negative and less than the size of the collection.
...
void main()
{
    ...
    u_xlat2.xyz = vec3(u_xlat16_9) * u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat16_0.x = texture(_Illum, vs_TEXCOORD0.zw).w;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_0.xxx + u_xlat16_3.xyz;
    SV_Target3.xyz = exp2((-u_xlat16_1.xyz));
    SV_Target3.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat0.xyz * u_xlat16_1.xyz;
    u_xlat16_0.x = texture(_Illum, vs_TEXCOORD0.zw).w;
    SV_Target3.xyz = u_xlat16_1.xyz * u_xlat16_0.xxx + u_xlat16_3.xyz;
    SV_Target3.w = 1.0;
    return;
}
